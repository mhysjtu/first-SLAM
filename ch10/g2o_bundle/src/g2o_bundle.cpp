/*
	2019/8/16
	g2o for BA problems in backend
*/
...
{   
    ...
    //std::unique_ptr<BalBlockSolver::PoseMatrixType> linearSolver;
...
void SolveProblem(const char* filename, const BundleParams& params)
{
    ...
    // store the initial 3D cloud points and camera pose into ply file
...
int main(int argc, char** argv)
{
    ...
    if(params.input.empty()){
        std::cout << "Usage: bundle_adjustment -input <path for dataset>";
        return 1;
    }
